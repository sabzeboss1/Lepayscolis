...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f9fafb; padding: 30px; border-radius: 0 0 5px 5px;">
        <h2 style="color: #ef4444;">Echec de la sauvegarde</h2>

        <p>Bonjour,</p>

        <p>Une sauvegarde {{ $backup->type->value === 'scheduled' ? 'planifiee' : 'manuelle' }} a echoue.</p>
        ...
        <div style="background-color: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 20px 0;">
            ...
            <p style="margin: 5px 0;"><strong>Date :</strong> {{ $backup->completed_at?->format('d/m/Y a H:i') }}</p>
        </div>

        <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 15px; margin: 20px 0;">
            <p style="margin: 0; color: #991b1b;"><strong>Erreur :</strong></p>
