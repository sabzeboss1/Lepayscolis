      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          <div className="flex-1 text-left min-w-0">
            <p className="text-xs sm:text-sm text-gray-500 truncate">{trip.departure.country}</p>
            <p className="font-semibold text-sm sm:text-base text-gray-900 truncate">{trip.departure.city}</p>
            <p className="text-xs text-gray-500 mt-1">{formatDate(trip.departure.date)}</p>
          </div>
          ...
          <div className="flex-1 text-right min-w-0">
            <p className="text-xs sm:text-sm text-gray-500 truncate">{trip.arrival.country}</p>
            <p className="font-semibold text-sm sm:text-base text-gray-900 truncate">{trip.arrival.city}</p>
            <p className="text-xs text-gray-500 mt-1">{formatDate(trip.arrival.date)}</p>
          </div>
        </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-xs text-gray-500 ml-1">
                ({trip.traveler.completedDeliveries})
              </span>
            </div>
          </div>
        </div>
