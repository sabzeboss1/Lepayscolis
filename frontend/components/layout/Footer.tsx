      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="flex items-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-md w-fit p-1"
            >
              <Image
                src="/logo.png"
            ...
            <p className="text-sm text-gray-600">{t('footer.companyInfo')}</p>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-600 hover:text-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md p-1 min-h-[44px] min-w-[44px] flex items-center justify-center"
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-600 hover:text-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md px-1 py-1 inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="pt-8 pb-8 border-t border-gray-200">
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-gray-600">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Paiement protégé</span>
            </div>
            <div className="flex items-center gap-2">
