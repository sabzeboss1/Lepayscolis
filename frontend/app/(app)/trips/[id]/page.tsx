        ...
        <Card className="mb-6" padding="lg">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-600">
                {trip.departure_country} to {trip.arrival_country}
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-6 border-t border-b border-gray-200">
            <div>
              ...
              <p className="text-gray-600 mt-1">{formatDate(trip.departure_date)}</p>
              <p className="text-sm text-gray-500">{formatTime(trip.departure_date)}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">{formatDate(trip.arrival_date)}</p>
              <p className="text-sm text-gray-500">{formatTime(trip.arrival_date)}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">
                  {calculateDuration(trip.departure_date, trip.arrival_date)}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{trip.available_capacity} kg</p>
              </div>
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div className="text-sm text-gray-600">
                    {trip.traveler.completed_deliveries} {t('profile.completedDeliveries')}
                  </div>
                </div>
