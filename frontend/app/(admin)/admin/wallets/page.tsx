  ...
  const columns: Column<Wallet>[] = [
    {
      ...
      render: (wallet) => (
        <div>
          <div className="font-medium text-gray-900">{wallet.user?.name ?? 'Utilisateur supprimé'}</div>
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable
        ...
        onRowClick={(wallet) => wallet.user && router.push(`/admin/wallets/${wallet.user.id}`)}
