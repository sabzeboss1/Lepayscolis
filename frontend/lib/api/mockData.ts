...
export function generateMockUser(overrides?: Partial<User>): User {
  const completedDeliveries = faker.number.int({ min: 0, max: 100 });
  const rating = faker.number.float({ min: 0, max: 5, fractionDigits: 1 });
  const isRecommended = rating >= 4.5 && completedDeliveries >= 5;
...
export function generateMockTrip(overrides?: Partial<Trip>): Trip {
  ...
  const traveler = generateMockUser({ kycStatus: 'approved' });
  ...
  return {
    ...
    acceptedPackageTypes: faker.helpers.arrayElements(
    ...
    travelProofUrl: faker.datatype.boolean({ probability: 0.7 }) 
      ? faker.image.url() 
      : undefined,
    status: 'active',
    createdAt: faker.date.past(),
...
export function generateMockShipment(overrides?: Partial<Shipment>): Shipment {
  const sender = generateMockUser({ kycStatus: 'approved' });
  const traveler = generateMockUser({ kycStatus: 'approved' });
  ...
  return {
    ...
    pickup: {
      city: faker.helpers.arrayElement(['Moscow', 'Saint Petersburg', 'Kazan']),
      country: 'Russia',
      address: faker.location.streetAddress(),
    },
    delivery: {
      city: faker.helpers.arrayElement(['Dakar', 'Abidjan', 'Douala']),
      country: faker.helpers.arrayElement(['Senegal', 'Ivory Coast', 'Cameroon']),
      address: faker.location.streetAddress(),
    },
    status: faker.helpers.arrayElement(['pending', 'accepted', 'in_transit', 'delivered']),
    payment: {
      amount: weight * pricePerKg,
      status: faker.helpers.arrayElement(['pending', 'escrowed', 'released']),
    },
    createdAt: faker.date.past(),
    ...overrides,
  };
...
export const demoMessagesForNewUser: Message[] = [
  // Conversation with Marie Dubois
  {
    ...
    read: true,
    createdAt: new Date('2025-02-02T10:30:00'),
  },
  {
    id: 'msg-demo-2',
    conversationId: 'conv-demo-1',
    ...
    read: true,
    createdAt: new Date('2025-02-02T10:35:00'),
  },
  {
    id: 'msg-demo-3',
    conversationId: 'conv-demo-1',
    ...
    read: true,
    createdAt: new Date('2025-02-02T10:40:00'),
  },
  {
    id: 'msg-demo-4',
    conversationId: 'conv-demo-1',
    ...
    read: true,
    createdAt: new Date('2025-02-02T10:45:00'),
  },
  {
    id: 'msg-demo-5',
    conversationId: 'conv-demo-1',
  ...
  },
  {
    ...
    read: true,
    createdAt: new Date('2025-02-02T14:15:00'),
  },
  {
    id: 'msg-demo-8',
    conversationId: 'conv-demo-2',
    ...
    read: false,
    createdAt: new Date('2025-02-02T14:30:00'),
  },
];
